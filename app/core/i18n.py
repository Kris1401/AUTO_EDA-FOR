...
_STRINGS = {
 "PL": {
  ...
  "page.ingest.title": "Analiza Danych — Wczytywanie (Etap 1 w przygotowaniu)",
  "page.chat.title": "Data Chat (Etap 3 w przygotowaniu)",
  "page.ml.title": "Trenowanie modelu (Etap 4 w przygotowaniu)",
  "page.predict.title": "Predykcja (Etap 6 w przygotowaniu)",
 ...
 "EN": {
  ...
  "page.ingest.title": "Data Analysis — Ingest (Stage 1 upcoming)",
  "page.chat.title": "Data Chat (Stage 3 upcoming)",
  "page.ml.title": "Model Training (Stage 4 upcoming)",
  "page.predict.title": "Prediction (Stage 6 upcoming)",
